...
TEST(CoalCachePairUnit, RepeatedContactTestReusesCache)  // NOLINT
{
  ...
  checker.setActiveCollisionObjects(std::vector<tesseract::common::LinkId>{ "link_a", "link_b" });
...
TEST(CoalCachePairUnit, ReregisteredObjectsGiveConsistentResults)  // NOLINT
{
  ...
  checker1.setActiveCollisionObjects(std::vector<tesseract::common::LinkId>{ "link_a", "link_b" });
  ...
  checker2.setActiveCollisionObjects(std::vector<tesseract::common::LinkId>{ "link_a", "link_b" });
...
TEST(CoalCachePairUnit, ActiveListPromotionEnablesContacts)  // NOLINT
{
  ...
  // --- Discrete manager ---
  {
    ...
    checker.setActiveCollisionObjects(std::vector<tesseract::common::LinkId>{ "link_a" });
