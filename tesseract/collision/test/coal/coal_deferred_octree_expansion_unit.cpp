...
{
  checker_.setActiveCollisionObjects(std::vector<tesseract::common::LinkId>{ "octree_link", "cyl_link" });
...
TEST_F(DeferredOctreeExpansionUnit, DualPoseTransformOnStaticOctreeIsHarmless)  // NOLINT
{
  ...
  checker_.setActiveCollisionObjects(std::vector<tesseract::common::LinkId>{ "cyl_link" });
